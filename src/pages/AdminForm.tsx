      ...
      <div className="min-h-screen bg-wallcraft-dark py-12">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            {/* Header */}
            <div className="mb-8">
              <h1 className="text-4xl font-bold text-foreground mb-2">Create Your Prompt</h1>
              <p className="text-muted-foreground">Fill in the details below to list your AI prompt</p>
            </div>
